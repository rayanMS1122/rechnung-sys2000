...
class ScreenInputController extends GetxController {
  ...
  BaustelleController get baustelleController => Get.find<BaustelleController>();
  EinstellungenService get einstellungenService => Get.find<EinstellungenService>();
  ...
  TextEditingController get firmaNameController => firmaController.firmaNameController;
  TextEditingController get firmaStrasseController => firmaController.firmaStrasseController;
  TextEditingController get firmaPlzController => firmaController.firmaPlzController;
  TextEditingController get firmaOrtController => firmaController.firmaOrtController;
  TextEditingController get firmaTelefonController => firmaController.firmaTelefonController;
  TextEditingController get firmaWebsiteController => firmaController.firmaWebsiteController;
  TextEditingController get firmaEmailController => firmaController.firmaEmailController;
  RxList<Map<String, dynamic>> get firmenListe => firmaController.firmenListe;

  // Kunde
  Rx<Kunde> get kunde => kundeController.kunde;
  TextEditingController get kundeNameController => kundeController.kundeNameController;
  TextEditingController get kundeStrasseController => kundeController.kundeStrasseController;
  TextEditingController get kundePlzController => kundeController.kundePlzController;
  TextEditingController get kundeOrtController => kundeController.kundeOrtController;
  TextEditingController get kundeTeleController => kundeController.kundeTeleController;
  TextEditingController get kundeEmailController => kundeController.kundeEmailController;
  ...
  TextEditingController get monteurVornameController => monteurController.monteurVornameController;
  TextEditingController get monteurNachnameController => monteurController.monteurNachnameController;
  TextEditingController get monteurTeleController => monteurController.monteurTeleController;
  TextEditingController get monteurEmailController => monteurController.monteurEmailController;
  RxList<Map<String, dynamic>> get monteureListe => monteurController.monteureListe;
  RxBool get canSaveMonteur => monteurController.canSaveMonteur;

  // Baustelle
  Rx<Baustelle> get baustelle => baustelleController.baustelle;
  TextEditingController get baustelleStrasseController => baustelleController.baustelleStrasseController;
  TextEditingController get baustellePlzController => baustelleController.baustellePlzController;
  TextEditingController get baustelleOrtController => baustelleController.baustelleOrtController;
  RxList<Map<String, dynamic>> get baustellenListe => baustelleController.baustellenListe;
  ...
  // Rechnung
  RxList<ReceiptData> get rechnungTextFielde => rechnungService.rechnungTextFielde;
  ...
  Future<void> _loadEinstellungenFromDB() async {
    ...
    if (einstellungen != null) {
      ...
      // Load Baustelle
      baustelleController.loadFromEinstellungen(einstellungen, kundeController.kunde);
  ...
  Future<void> selectFirmaFromDatabase(int id) => firmaController.selectFirmaFromDatabase(id);
  ...
  // MONTEUR
  Future<bool> addMonteurToDatabase() => monteurController.addMonteurToDatabase();
  Future<void> selectMonteurFromDatabase(int id, {bool showSnackbar = true}) =>
      monteurController.selectMonteurFromDatabase(id, showSnackbar: showSnackbar);
  void updateMonteurControllers() => monteurController.updateMonteurControllers();

  // BAUSTELLE
  Future<void> addBaustelleToDatabase() => baustelleController.addBaustelleToDatabase();
  Future<void> selectBaustelleFromDatabase(int id) =>
      baustelleController.selectBaustelleFromDatabase(id, kundeController.kunde);
  ...
  // BILDER
  Future<void> addImagesToPosition(int index, {ImageSource source = ImageSource.gallery}) =>
      bilderService.addImagesToPosition(index, source: source);
  Future<void> addImageFromCamera(int index) => bilderService.addImageFromCamera(index);
  ...
  void removeAllImagesFromPosition(int index) => bilderService.removeAllImagesFromPosition(index);
  List<String> getImagesForPosition(int index) => bilderService.getImagesForPosition(index);
}
