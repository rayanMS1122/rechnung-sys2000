...
class ReceiptScreenNew extends StatefulWidget {
  final List<ReceiptData> receiptData;
  const ReceiptScreenNew({super.key, required this.receiptData});

  @override
  State<ReceiptScreenNew> createState() => _ReceiptScreenNewState();
}

class _ReceiptScreenNewState extends State<ReceiptScreenNew> {
                        ...
                        child: pw.Column(
                          ...
                          children: [
                            ...
                            if (_screenInputController
                              ...
                              pw.SizedBox(height: 3),
                              pw.Text(
                                _screenInputController.firmaEmailController.text,
                                style: pw.TextStyle(
                                  font: ocrFont,
                                  fontSize: 9,
                        ...
                        child: pw.Column(
                          ...
                          children: [
                            ...
                            if (_screenInputController
                                ...
                                _screenInputController
                                    .baustelleOrtController.text.isNotEmpty) ...[
                              pw.SizedBox(height: 3),
                              pw.Text(
                      ...
                      if (item.img != null && item.img!.isNotEmpty) {
                        ...
                        if (imageWidgets.isNotEmpty) {
                          widgets.add(
                            pw.Container(
                              color: isEven ? PdfColors.grey100 : PdfColors.white,
                              padding: pw.EdgeInsets.only(left: 12, right: 12, bottom: 10),
                              child: pw.Wrap(
                                spacing: 6,
                                runSpacing: 6,
                          ...
                          pw.Column(
                            children: [
                              ...
                              pw.Container(
                                ...
                                child: _unterschriftController.kundePngBytes.value != null
                                    ? pw.Image(
                                        pw.MemoryImage(
                          ...
                          pw.Column(
                            children: [
                              ...
                              pw.Container(
                                ...
                                child: _unterschriftController.monteurPngBytes.value != null
                                    ? pw.Image(
                                        pw.MemoryImage(
